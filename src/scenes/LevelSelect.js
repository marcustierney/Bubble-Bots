class LevelSelect extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(game.config.width/2, game.config.height/1.5, 'square-font', 'Level Two', 18).setOrigin(0.5)
    ...
    update() {
      if (Phaser.Input.Keyboard.JustDown(this.keyDOWN) && this.selectedLevel === 1) {
