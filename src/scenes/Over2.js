class Over2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.bitmapText(game.config.width/2, game.config.height/2.2, 'text-font', 'Press R to Restart', 20).setOrigin(0.5)
        this.add.bitmapText(game.config.width/2, game.config.height/1.8, 'text-font', 'Press M for Menu', 20).setOrigin(0.5)
